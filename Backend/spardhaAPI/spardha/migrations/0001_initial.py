    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.IntegerField(choices=[(1, 'A'), (2, 'B'), (3, 'C'), (4, 'D')], help_text='A - Football, Hockey, Cricket, Khokho, Basketball, Water Polo.  B - Lawn Tennis, Volleyball. C - Badminton, Table Tennis, Squash. D - Rest everything')),
            ],
        ),
        migrations.CreateModel(
            name='Stage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team1_game1', models.IntegerField(blank=True, null=True)),
                ('team2_game1', models.IntegerField(blank=True, null=True)),
                ('team1_game2', models.IntegerField(blank=True, null=True)),
                ('team2_game2', models.IntegerField(blank=True, null=True)),
                ('team1_game3', models.IntegerField(blank=True, null=True)),
                ('team2_game3', models.IntegerField(blank=True, null=True)),
                ('team1_game4', models.IntegerField(blank=True, null=True)),
                ('team2_game4', models.IntegerField(blank=True, null=True)),
                ('team1_game5', models.IntegerField(blank=True, null=True)),
                ('team2_game5', models.IntegerField(blank=True, null=True)),
